...
public class SetupPresentGoalCommand implements SubCommandExecuter {
    @Override
    public boolean onCommand(CommandSender commandSender, Command cmd, String s, String[] args, String command) {
        ...
        if (arena != null) {
            arena.setPresentGoal(Bukkit.getPlayer(commandSender.getName()).getLocation());
            commandSender.sendMessage("Geschenk abgabe Position für " + arenaName + " wurde auf deine Position gesetzt");
