...
public class SetupWinnerOtherCommand implements SubCommandExecuter {
    @Override
    public boolean onCommand(CommandSender commandSender, Command cmd, String s, String[] args, String command) {
        ...
        if (arena != null) {
            arena.setOtherWinners(Bukkit.getPlayer(commandSender.getName()).getLocation());
            commandSender.sendMessage("Die position von Other-Winners für " + arenaName + " wurde auf deine Position gesetzt");
