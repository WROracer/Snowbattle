...
public class SetupWinnerFirstCommand implements SubCommandExecuter {
    @Override
    public boolean onCommand(CommandSender commandSender, Command cmd, String s, String[] args, String command) {
        ...
        if (arena != null) {
            arena.setFirstPlace(Bukkit.getPlayer(commandSender.getName()).getLocation());
            commandSender.sendMessage("Erste Platz position für " + arenaName + " wurde auf deine Position gesetzt");
