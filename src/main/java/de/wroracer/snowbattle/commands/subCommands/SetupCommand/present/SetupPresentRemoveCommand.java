...
public class SetupPresentRemoveCommand implements SubCommandExecuter {
    @Override
    public boolean onCommand(CommandSender commandSender, Command cmd, String s, String[] args, String command) {
        ...
        if (arena != null) {
            arena.deletePresetnLocation();
            commandSender.sendMessage("Present Positionen für " + arenaName + " wurde Entfernd");
