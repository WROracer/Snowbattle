...
public class SetupWinnerThirdCommand implements SubCommandExecuter {
    @Override
    public boolean onCommand(CommandSender commandSender, Command cmd, String s, String[] args, String command) {
        ...
        if (arena != null) {
            arena.setThirdPlace(Bukkit.getPlayer(commandSender.getName()).getLocation());
            commandSender.sendMessage("Dritter platz Position für " + arenaName + " wurde auf deine Position gesetzt");
